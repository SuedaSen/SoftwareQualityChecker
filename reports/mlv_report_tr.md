...
> Not: Bu rapor kısaltılmıştır — Belirsizlik satırları: 300/489, tutarsızlık adayları: 200/53512. Metinler çok uzunsa kısaltılır.

## Değerlendirme (Belirsizlik)

- Eşik (threshold; score'u 0/1 etikete çeviren sınır): 0.35
- Precision (tahmin edilen positive'ların ne kadarı doğru): 0.333
- Recall (gold positive'ların ne kadarı yakalandı): 0.429
- F1 (Precision ve Recall'un harmonik ortalaması): 0.375
- TP/FP/FN/TN: 3/6/4/7
...
- Precision (tahmin edilen positive'ların ne kadarı doğru): 0.429
- Recall (gold positive'ların ne kadarı yakalandı): 0.857
- F1 (Precision ve Recall'un harmonik ortalaması): 0.571
- TP/FP/FN/TN: 6/8/1/5
